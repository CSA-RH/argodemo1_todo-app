...
> **Manual step**: corresponds to `argocd/applicationset-push.yaml`
>
> After this step, ArgoCD takes over: the `kustomize/` directory is managed
> by ArgoCD and should **not** be applied manually.
...
| `requeueAfterSeconds: 180` | How often the generator re-reads PlacementDecision to detect cluster changes. |
